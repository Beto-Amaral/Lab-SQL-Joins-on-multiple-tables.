...
-- store s.store_id, s.adress_id address a.address_id, a.city_id, city c.city_id, c.name, c_country_id, country as cc cc.country_id, cc.country
use sakila; 
select * from store limit 2; -- store_id, address_id
select * from city limit 2; -- city_id country_id, city
select * from country limit 2; -- country_id, coutry 
select * from address limit 2; -- address_id, city_id 
